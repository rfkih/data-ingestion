...
| split_ex_20 | 28 (38) | -2.21 % / -3.26 % | -0.53 | 32 % | -1.50 % | +0.70 % | +0.62 % (0.16) | -1.16 % (-0.28) | 9 (-2.0 %/+2.9 %/+8.7 %) | 2/3 | -2.56 % | -2.36 % | H10 n28 -3.0 %; H40 n28 -3.4 %; floor1bn n38 -0.9 % | -0.9 % / -0.52 / -8 % | 0.00 | **UNTESTABLE** |
| buyback_ann_20 | 115 (150) | -0.34 % / -1.18 % | -0.26 | 44 % | +0.58 % | +0.92 % | -1.77 % (-1.20) | -0.83 % (-0.74) | 12 (-1.6 %/+0.6 %/+2.8 %) | 1/3 | -0.80 % | -0.87 % | H10 n116 +0.7 %; H40 n113 +2.0 %; floor1bn n150 -0.3 % | -0.5 % / -0.01 / -21 % | 0.00 | **CLOSED** |
...
| rights_ann_20 | 41 (58) | +3.37 % / -2.08 % | 0.62 | 46 % | +4.46 % | +1.10 % | +7.27 % (1.39) | +5.03 % (0.98) | 61 (-2.9 %/+3.8 %/+11.5 %) | exc<0 0/4 | +2.83 % | +2.67 % | H10 n42 -0.2 %; H40 n39 -0.7 %; floor1bn n58 +1.4 % | +0.9 % / 0.19 / -12 % | 0.00 | **CLOSED (no avoid signal)** |
...
| buyback_ann_20 | +1.2 % | +0.7 % | +0.6 % | +0.2 % | -0.8 % | +1.7 % | -0.2 % | +0.5 % (99) |
