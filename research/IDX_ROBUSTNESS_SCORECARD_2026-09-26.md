# IDX menu 25 — robustness scorecard of every researched strategy — 2026-09-26 — 17 new trials, cumulative N = 479
...
|---|---|---|---|---|---|---|---|
| Value strict composite, annual May (live) | 2020-26, 7 rebalances, ~12 names | 5/6 pass | Sharpe at pct 100 of 200 random strict-pool books (median 0.37) | beats strict pool in 2/2 halves | x1.5 costs CAGR 20.9 % (rule 21.1); delay: none (09-13) | DSR 0.301 | **ROBUST** |
| Asymmetric RSI30 entry / MA200-cross exit on the strict list | 2021-26, 4 calendars, monthly | 2/4 pass its bar | Sharpe advantage at pct 91 of 100 shifted signals | asym > none in 2/2 halves | 1 session late -1.3 pt, 5 late -2.7 (09-13) | - | **FRAGILE** |
...
| Combined book value + trend | 2021-26 daily, corr +0.36 | 5/5 weights pass the money rule | - | 50/50 passes in 1/2 halves | inherits sleeves | - | **PARTIAL: T** |
...
Rule: CAGR +21.1 %, Sharpe 1.03, mDD 22 %, DSR 0.301. Strict-pool equal weight: CAGR +9.3 %, Sharpe 0.53, mDD 34 %.

| neighbour | names | CAGR | Sharpe | mDD | read |
|---|---|---|---|---|---|
| top_quarter | 14 | +26.5 % | 1.17 | 27 % | PASS |
| top_sixth | 10 | +18.0 % | 0.89 | 23 % | PASS |
| top_eighth | 10 | +17.7 % | 0.88 | 22 % | fail |
| ep_only | 12 | +27.3 % | 1.05 | 32 % | PASS |
| ep_bp | 12 | +25.6 % | 1.03 | 30 % | PASS |
| loose_gate | 17 | +19.4 % | 0.95 | 23 % | PASS |

Placebo: 200 random books of the rule's size from the strict pool at each rebalance — median Sharpe 0.37, CAGR +7.6 %, mDD 40 %; 95th percentile Sharpe 0.78, CAGR +19.1 %. The rule sits at percentile 100 (Sharpe), 99 (CAGR); its drawdown is shallower than 100 % of the random books. PASS.

- 2020-23: rule CAGR +31.2 %, Sharpe 1.38, mDD 18 %; strict pool CAGR +17.4 %, Sharpe 1.03, mDD 15 %.
- 2023-26: rule CAGR +12.9 %, Sharpe 0.69, mDD 22 %; strict pool CAGR +2.6 %, Sharpe 0.14, mDD 34 %.
- costs x 1.5: CAGR +20.9 %, Sharpe 1.02, mDD 22 %.

## S5. Asymmetric rule (RSI entry, MA cross exit) on the strict list

| calendar | none | asym_rsi |
|---|---|---|
| 5 | CAGR +16.9 %, Sharpe 0.94, mDD 22 % | CAGR +16.1 %, Sharpe 1.15, mDD 16 % |
| 2 | CAGR +22.8 %, Sharpe 1.19, mDD 21 % | CAGR +15.7 %, Sharpe 1.06, mDD 17 % |
| 8 | CAGR +15.4 %, Sharpe 0.89, mDD 19 % | CAGR +15.2 %, Sharpe 1.06, mDD 16 % |
| 11 | CAGR +12.1 %, Sharpe 0.76, mDD 22 % | CAGR +12.2 %, Sharpe 0.95, mDD 14 % |

Its own bar: Sharpe > none with CAGR >= 90 % in 3/4 calendars, worst mDD 17 vs 22 -> PASS.

| neighbour | wins | worst mDD | none worst | avg CAGR | avg Sharpe | read |
|---|---|---|---|---|---|---|
| rsi25 | 0/4 | 17 % | 22 % | +11.9 % | 0.91 | fail |
| rsi35 | 3/4 | 19 % | 22 % | +15.0 % | 0.98 | PASS |
| sma150 | 1/4 | 16 % | 22 % | +12.4 % | 0.91 | fail |
| sma250 | 3/4 | 18 % | 22 % | +14.8 % | 1.04 | PASS |

Placebo (May calendar): real Sharpe advantage over none +0.20; 100 shifted signals median -0.03, 95th +0.23; real at percentile 91 -> FAIL.

- early: none CAGR +14.7 %, Sharpe 0.83, mDD 21 %; asym CAGR +16.3 %, Sharpe 1.10, mDD 16 %.
- late: none CAGR +19.6 %, Sharpe 1.08, mDD 22 %; asym CAGR +16.0 %, Sharpe 1.21, mDD 13 %.

## S7. Combined book value + trend

| weights value/trend | CAGR | Sharpe | mDD | money rule |
|---|---|---|---|---|
| 30/70 | +24.8 % | 1.25 | -25 % | pass |
| 40/60 | +23.7 % | 1.27 | -23 % | pass |
| 50/50 | +22.6 % | 1.26 | -22 % | pass |
| 60/40 | +21.4 % | 1.24 | -22 % | pass |
| 70/30 | +20.1 % | 1.18 | -22 % | pass |

- 50/50 2021-23: CAGR +14.4 %, Sharpe 0.89, mDD -18 %.

- 50/50 2024-26: CAGR +32.7 %, Sharpe 1.66, mDD -22 %.
